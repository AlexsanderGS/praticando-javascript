/* Imagine que você está desenvolvendo um sistema de avaliação para um jogo educativo.Ao final de cada fase, o jogador acumula uma pontuação total, 
e o sistema precisa avaliar se ele:
...
function exibeMensagem(pontuacao) {
  if (pontuacao >= 70) {
...
avaliarDesempenho(82, exibeMensagem);
avaliarDesempenho(58, exibeMensagem);
avaliarDesempenho(49, exibeMensagem);
